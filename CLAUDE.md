...
**YOU ARE IN: `beads_ui/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/beads_ui/` (rig root) or other directories
...
**Your mail address:** `beads_ui/polecats/furiosa`
**Your rig:** beads_ui
**Your Witness:** `beads_ui/witness`
...
| Ask Witness for help | `gt mail send beads_ui/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`beads_ui/witness`) when:
...
```bash
gt mail send beads_ui/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
